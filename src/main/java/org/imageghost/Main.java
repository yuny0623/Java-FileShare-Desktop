...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Connection.httpPostRequest("http://localhost:8080/test-post", hashMap);

        System.out.println("----------GET test---------");
        String result = Connection.httpGetRequest("http://localhost:8080/test-get/", "18r1v38cb1o3ryg14o3ggo13ubgh34g13");
